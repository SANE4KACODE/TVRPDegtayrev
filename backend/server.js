...
// Получение всех тарифов со списком услуг
app.get('/tariffs', (req, res) => {
    ...
    db.query(sql, (err, results) => {
        ...
        // Группируем результат по тарифам
        const tariffs = {};
...
app.post('/tariffs/add', (req, res) => {
    // tariff_code — уникальный и не меняется, tariff_name — редактируемый
